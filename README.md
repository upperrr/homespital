...
- 전체진료리스트보기 및 검색
- 의료진 검색
- 예약시작/진료시작/완료/조제완료시 문자전송 
- 예약시작/진료시작/완료/조제완료시 web noti
- 사업자 번호 확인(API)
...
### 이훈
- 환자 예약 페이지 기본 틀 작업 및 카카오맵 API 연결 작업
- 네비바 및 사이드바 작업
- 진료 예약 및 약사 약국 제조시 아임포트 REST API를 통한 카드 정보 저장 및 결제 기능 구현
- 화상채팅 기능 구현
- 영상 편집 보조(컷편집)
- 전체 기술보조
